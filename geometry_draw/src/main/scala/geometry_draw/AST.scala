...
case class Point(x_coordinate: Double, y_coordinate: Double, color: String = "black", thickness: Double = 0.005) extends Action
case class Line(start_point: Point, end_point: Point, color: String = "black", thickness: Double = 0.005) extends Action
...
case class RemoveThePoint(point: Point) extends Action
case class RemoveTheLine(line: Line) extends Action

case class CheckThePoint(input: String) extends Action
