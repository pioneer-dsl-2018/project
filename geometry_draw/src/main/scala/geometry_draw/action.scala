...
case class MarkThePoint(point: Point)
  extends Action

case class SetPointProperty(point: Point, color: String, thickness: Double)
  extends Action

case class Arc(center:Point, radius: Double, rotation_property: Rotation)
  extends Action
